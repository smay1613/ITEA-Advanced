    ...
    : m_readerInstance {ContactsNetworkReader::instance()}
{
    ...
    connect(this, &ContactsModel::signalToAddContact,
            &m_readerInstance, &ContactsNetworkReader::onSignalToAddContact);
...
void ContactsModel::addContact(QString firstName, QString secondName, QString phone)
{
    qDebug() << "ContactsModel::addContact";
    QStringList newContact {firstName, secondName, phone};
    QVariant data {newContact};
    emit signalToAddContact(newContact);
}
